...
boot::inv.logit( estPsi) ## Estimated : 0.269, Actual = 0.261

## Probabilty of colonization

boot::inv.logit( estGamm) ## Estimated : 0.138, Actual = 0.15

## Probabilty of survival

1 - boot::inv.logit( estSurv) ## Estimated : 0.733 ,Actual = 0.75

## Probability of detection

boot::inv.logit( estP) ## Estimated : 0.557 , Actual = 0.510
